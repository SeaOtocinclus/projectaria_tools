    ...
    def build_extension(self, ext):
        ...
        if self.compiler.compiler_type != "msvc":
            ...
            if os.path.exists("vcpkg"):
                ...
                vcpkg_toolchain_relative_filepath = "vcpkg\\scripts\\buildsystems\\vcpkg.cmake"
                cmake_args += [f"-DCMAKE_TOOLCHAIN_FILE={os.path.abspath(vcpkg_toolchain_relative_filepath)}"] 
